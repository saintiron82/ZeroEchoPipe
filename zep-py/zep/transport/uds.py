"""ZEP UDS transport — Unix Domain Socket with Frame Profile.

Frame Profile: 4-byte big-endian length prefix + JSON payload.
Unix/macOS only. Native performance (~20us latency).
"""
...
class UdsTransport(BaseTransport):
